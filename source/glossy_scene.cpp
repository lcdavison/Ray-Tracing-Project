...
int main ( int argc, char** argv )
{
	...
	MultiJitteredSampler sampler ( 25, 1 );
	...
	BlinnPhong* s_mat = new BlinnPhong ( ColourRGB ( 0.8f, 0.8f, 0.3f ), 0.0f, 0.0f, 0.0f, 5.0f, RT_GLOSSY );

	Sphere* sphere = new Sphere ( Point3 ( 80.0, 25.0, -100.0 ), 80.0 );
	sphere->set_material ( s_mat );
	scene.add_geometry ( sphere );

	Phong* p_mat = new Phong ( ColourRGB ( 0.0f, 0.8f, 0.0f ), 0.1f, 0.9f, 0.1f, 100.0f, RT_REFLECTIVE );
