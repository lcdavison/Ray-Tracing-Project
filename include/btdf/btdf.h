...
class IBTDF 
{
	public:
		...
		virtual ColourRGB 	reflectance 		  ( const HitResult&, const Vector3&, const Vector3& ) 	= 0;
		virtual bool 		total_internal_reflection ( const HitResult&, const Ray& ) = 0;	//	Determines whether a ray is transmitted
};
#endif
